...
*/
namespace FaustUtilities_WhiteNoiseGenerator {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_WhiteNoiseGenerator))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_WhiteNoiseGenerator _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"WhiteNoiseGenerator\",	\"filename\": \"WhiteNoiseGenerator.dsp\",	\"version\": \"2.37.3\",	\"compile_options\": \"-lang cpp -es 1 -single -ftz 0\",	\"include_pathnames\": [\"/usr/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/home/mtdml/Desktop/workbench/DSPs/WhiteNoiseGenerator/.\"],	\"inputs\": 0,	\"outputs\": 1,	\"meta\": [ 		{ \"author\": \"Grame\" },		{ \"compile_options\": \"-lang cpp -es 1 -single -ftz 0\" },		{ \"copyright\": \"(c)GRAME 2009\" },		{ \"filename\": \"WhiteNoiseGenerator.dsp\" },		{ \"license\": \"BSD\" },		{ \"name\": \"WhiteNoiseGenerator\" },		{ \"version\": \"1.1\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"WhiteNoiseGenerator\",			\"items\": [ 				{					\"type\": \"vslider\",					\"label\": \"Volume\",					\"address\": \"/WhiteNoiseGenerator/Volume\",					\"meta\": [						{ \"acc\": \"0 0 -10 0 10\" },						{ \"style\": \"knob\" }					],					\"init\": 0.5,					\"min\": 0,					\"max\": 1,					\"step\": 0.1				}			]		}	]}";
			...
			_dsp = (FaustPlugin_WhiteNoiseGenerator) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_WhiteNoiseGenerator";
        #elif UNITY_IOS
        const string _dllName = "__Internal";
        #elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
        const string _dllName = "FaustPlugin_WhiteNoiseGenerator";
        #else
