...
*/
namespace FaustUtilities_HighPassFilter {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_HighPassFilter))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_HighPassFilter _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"HighPassFilter\",	\"filename\": \"HighPassFilter.dsp\",	\"version\": \"2.37.3\",	\"compile_options\": \"-lang cpp -es 1 -single -ftz 0\",	\"include_pathnames\": [\"/usr/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/home/mtdml/Desktop/workbench/DSPs/HPF/.\"],	\"inputs\": 1,	\"outputs\": 1,	\"meta\": [ 		{ \"compile_options\": \"-single -scal -I libraries/ -I project/ -lang wasm\" },		{ \"filename\": \"HighPassFilter.dsp\" },		{ \"library_path0\": \"/libraries/maxmsp.lib\" },		{ \"library_path1\": \"/libraries/maths.lib\" },		{ \"library_path2\": \"/libraries/platform.lib\" },		{ \"maths_lib_author\": \"GRAME\" },		{ \"maths_lib_copyright\": \"GRAME\" },		{ \"maths_lib_license\": \"LGPL with exception\" },		{ \"maths_lib_name\": \"Faust Math Library\" },		{ \"maths_lib_version\": \"2.5\" },		{ \"maxmsp_lib_author\": \"GRAME\" },		{ \"maxmsp_lib_copyright\": \"GRAME\" },		{ \"maxmsp_lib_license\": \"LGPL with exception\" },		{ \"maxmsp_lib_name\": \"MaxMSP compatibility Library\" },		{ \"maxmsp_lib_version\": \"1.1\" },		{ \"name\": \"HighPassFilter\" },		{ \"platform_lib_name\": \"Generic Platform Library\" },		{ \"platform_lib_version\": \"0.3\" },		{ \"version\": \"2.54.11\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"HighPassFilter\",			\"items\": [ 				{					\"type\": \"hslider\",					\"label\": \"Freq\",					\"address\": \"/HighPassFilter/Freq\",					\"init\": 1000,					\"min\": 100,					\"max\": 10000,					\"step\": 1				},				{					\"type\": \"hslider\",					\"label\": \"Q\",					\"address\": \"/HighPassFilter/Q\",					\"init\": 1,					\"min\": 0.01,					\"max\": 100,					\"step\": 0.01				}			]		}	]}";
			...
			_dsp = (FaustPlugin_HighPassFilter) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_HighPassFilter";
        #elif UNITY_IOS
        const string _dllName = "__Internal";
        #elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
        const string _dllName = "FaustPlugin_HighPassFilter";
        #else
