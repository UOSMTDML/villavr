...
*/
namespace FaustUtilities_SineGenerator {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_SineGenerator))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_SineGenerator _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"SineGenerator\",	\"filename\": \"SineGenerator.dsp\",	\"version\": \"2.37.3\",	\"compile_options\": \"-lang cpp -es 1 -single -ftz 0\",	\"include_pathnames\": [\"/usr/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/home/mtdml/Desktop/workbench/DSPs/Sine/.\"],	\"inputs\": 0,	\"outputs\": 1,	\"meta\": [ 		{ \"author\": \"Grame\" },		{ \"basics_lib_name\": \"Faust Basic Element Library\" },		{ \"basics_lib_version\": \"0.9\" },		{ \"compile_options\": \"-single -scal -I libraries/ -I project/ -lang wasm\" },		{ \"copyright\": \"(c)GRAME 2009\" },		{ \"filename\": \"SineGenerator.dsp\" },		{ \"library_path0\": \"/libraries/stdfaust.lib\" },		{ \"library_path1\": \"/libraries/oscillators.lib\" },		{ \"library_path2\": \"/libraries/platform.lib\" },		{ \"library_path3\": \"/libraries/maths.lib\" },		{ \"library_path4\": \"/project/basics.lib\" },		{ \"library_path5\": \"/libraries/signals.lib\" },		{ \"license\": \"BSD\" },		{ \"maths_lib_author\": \"GRAME\" },		{ \"maths_lib_copyright\": \"GRAME\" },		{ \"maths_lib_license\": \"LGPL with exception\" },		{ \"maths_lib_name\": \"Faust Math Library\" },		{ \"maths_lib_version\": \"2.5\" },		{ \"name\": \"SineGenerator\" },		{ \"oscillators_lib_name\": \"Faust Oscillator Library\" },		{ \"oscillators_lib_version\": \"0.3\" },		{ \"platform_lib_name\": \"Generic Platform Library\" },		{ \"platform_lib_version\": \"0.3\" },		{ \"signals_lib_name\": \"Faust Signal Routing Library\" },		{ \"signals_lib_version\": \"0.3\" },		{ \"version\": \"2.54.11\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"Oscillator\",			\"items\": [ 				{					\"type\": \"hslider\",					\"label\": \"freq\",					\"address\": \"/Oscillator/freq\",					\"meta\": [						{ \"unit\": \"Hz\" }					],					\"init\": 1000,					\"min\": 20,					\"max\": 24000,					\"step\": 1				},				{					\"type\": \"hslider\",					\"label\": \"volume\",					\"address\": \"/Oscillator/volume\",					\"meta\": [						{ \"unit\": \"dB\" }					],					\"init\": 0,					\"min\": -96,					\"max\": 0,					\"step\": 0.1				}			]		}	]}";
			...
			_dsp = (FaustPlugin_SineGenerator) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_SineGenerator";
        #elif UNITY_IOS
        const string _dllName = "__Internal";
        #elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
        const string _dllName = "FaustPlugin_SineGenerator";
        #else
