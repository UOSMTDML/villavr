...
*/
namespace FaustUtilities_BandPassFilter {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_BandPassFilter))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_BandPassFilter _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"BandPassFilter\",	\"filename\": \"BandPassFilter.dsp\",	\"version\": \"2.37.3\",	\"compile_options\": \"-lang cpp -es 1 -single -ftz 0\",	\"include_pathnames\": [\"/usr/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/home/mtdml/Desktop/workbench/DSPs/BandPassFilter/.\"],	\"inputs\": 1,	\"outputs\": 1,	\"meta\": [ 		{ \"author\": \"Grame\" },		{ \"basics_lib_name\": \"Faust Basic Element Library\" },		{ \"basics_lib_version\": \"0.9\" },		{ \"compile_options\": \"-single -scal -I libraries/ -I project/ -lang wasm\" },		{ \"copyright\": \"(c)GRAME 2006\" },		{ \"filename\": \"BandPassFilter.dsp\" },		{ \"filters_lib_lowpass0_highpass1\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters_lib_name\": \"Faust Filters Library\" },		{ \"filters_lib_version\": \"0.3\" },		{ \"library_path0\": \"/libraries/stdfaust.lib\" },		{ \"library_path1\": \"/libraries/filters.lib\" },		{ \"library_path2\": \"/project/basics.lib\" },		{ \"library_path3\": \"/libraries/maths.lib\" },		{ \"library_path4\": \"/libraries/platform.lib\" },		{ \"license\": \"BSD\" },		{ \"maths_lib_author\": \"GRAME\" },		{ \"maths_lib_copyright\": \"GRAME\" },		{ \"maths_lib_license\": \"LGPL with exception\" },		{ \"maths_lib_name\": \"Faust Math Library\" },		{ \"maths_lib_version\": \"2.5\" },		{ \"name\": \"BandPassFilter\" },		{ \"platform_lib_name\": \"Generic Platform Library\" },		{ \"platform_lib_version\": \"0.3\" },		{ \"version\": \"2.54.11\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"Bandfilter\",			\"items\": [ 				{					\"type\": \"nentry\",					\"label\": \"Q factor\",					\"address\": \"/Bandfilter/Q factor\",					\"meta\": [						{ \"style\": \"knob\" }					],					\"init\": 50,					\"min\": 0.1,					\"max\": 100,					\"step\": 0.1				},				{					\"type\": \"nentry\",					\"label\": \"freq\",					\"address\": \"/Bandfilter/freq\",					\"meta\": [						{ \"style\": \"knob\" },						{ \"unit\": \"Hz\" }					],					\"init\": 1000,					\"min\": 20,					\"max\": 20000,					\"step\": 1				},				{					\"type\": \"vslider\",					\"label\": \"gain\",					\"address\": \"/Bandfilter/gain\",					\"meta\": [						{ \"unit\": \"dB\" }					],					\"init\": 0,					\"min\": -50,					\"max\": 50,					\"step\": 0.1				}			]		}	]}";
			...
			_dsp = (FaustPlugin_BandPassFilter) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
        ...
        const string _dllName = "libFaustPlugin_BandPassFilter";
        #elif UNITY_IOS
        const string _dllName = "__Internal";
        #elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
        const string _dllName = "FaustPlugin_BandPassFilter";
        #else
