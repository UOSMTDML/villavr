...
// Credits: Evan X. Merz
// https://evanxmerz.com/post/recording-in-game-audio-in-unity

using UnityEngine;
using System;
using System.IO;

public class CustomAudioRenderer : MonoBehaviour
{
    #region Fields, Properties, and Inner Classes

    // values for the wave file header
    ...
    */ 
    ...
    public CustomAudioRenderer.Result Save(string filename)
    {
        Result result = new CustomAudioRenderer.Result();
        ...
        if (outputStream.Length > 0)
        {
            ...
            if (filename.Length > 0)
            {
                ...
                if (File.Exists(filename))
                    Debug.LogWarning("[CustomAudioRenderer] Overwriting " + filename + "...");
                ...
                // for debugging only
                Debug.Log("[CustomAudioRenderer] Finished saving to " + filename + ".");
            }
        ...
        {
            Debug.LogWarning("[CustomAudioRenderer] There is no audio data to save!");
